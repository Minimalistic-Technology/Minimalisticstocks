  ...
  return (
    <div className="flex h-screen w-full">
      <div className="w-full flex justify-center items-center bg-green-100">
        ...
        {step === 3 ? (<h2 className="text-2xl text-black font-bold text-center mb-6">
            Signup
          </h2>) :  (<h2 className="text-2xl text-black font-bold text-center mb-6">
            Login
          </h2>)
        }
          {step === 1 && (
          ...
          {step === 3 && (
            <>
              ...
              <p className=" mt-3 text-center text-emerald-950">
                Already signed up? <span className="mt-4 text-center text-sm text-blue-600 cursor-pointer hover:underline"
                onClick={() => setStep(4)}>Login here</span>
              </p>
            </>
          )}
          {step === 4 && (
